...
/*
   ...
   public AddressVo Address1 { get; private set; } = null!;
   public AddressVo Address2 { get; private set; } = null!;
   public AddressVo Address3 { get; private set;} = null!;
   #endregion
   ...
   public Seed(IClock clock) {
      ...
      //---------- Addresses ----------
      Address1 = AddressVo.Create("Hauptstr. 23", "29556", "Suderburg", "DE").GetValueOrThrow();
      Address2 = AddressVo.Create("Bahnhofstr.10", "10115", "Berlin").GetValueOrThrow();
      Address3 = AddressVo.Create("Schillerstr. 1", "30123", "Hannover", "DE").GetValueOrThrow();
...
/*      
   ...
   public void AddBenficiaries() {
      Account1.AddBeneficiary(Beneficiary1.ToBeneficiaryDto(),_clock.UtcNow);
