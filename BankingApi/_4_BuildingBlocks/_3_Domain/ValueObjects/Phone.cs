...
public sealed record class Phone {
   ...
   /// Phone can never exist in invalid state.
   /// </summary>
   ...
   public static Result<Phone> Create(string? input) {
      ...
      if (normalized.IsFailure)
         return Result<Phone>.Failure(normalized.Error);
      return Result<Phone>.Success(new Phone(normalized.Value!));
   }

   // =========================================================
   // 2) FACTORY — DATABASE (trusted)
   // =========================================================
   internal static Phone FromPersisted(string value) {
   ...
   // =========================================================
   // Input	                  Output
   // 0511 1234567	         05111234567
   // +49 511 1234567	      +495111234567
